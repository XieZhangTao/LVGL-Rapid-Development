...
static inline 
void emb_list_insert_head(emb_list_t *ptNode, emb_list_t *ptList)
{
    _emb_list_add(ptNode, ptList, ptList->ptNext);
}

static inline 
void emb_list_insert_tail(emb_list_t *ptNode, emb_list_t *ptList)
{
    _emb_list_add(ptNode, ptList->ptPrev, ptList);
}

static inline 
void emb_list_delete_node(emb_list_t *ptNode)
{
...
static inline
void emb_list_move_tail(emb_list_t *ptNode, emb_list_t *ptList)
{
    emb_list_delete_node(ptNode);
    emb_list_insert_tail(ptNode, ptList);
}

static inline
void emb_list_move_head(emb_list_t *ptNode, emb_list_t *ptList)
{
    emb_list_delete_node(ptNode);
    emb_list_insert_head(ptNode, ptList);
}
...
static inline 
bool emb_list_is_last(const emb_list_t *ptNode, const emb_list_t *ptList)
{
