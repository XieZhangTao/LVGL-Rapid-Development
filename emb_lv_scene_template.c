...
static void ui_event_cb(lv_event_t *ptEvent);
static void ui_timer_cb(lv_timer_t *ptTimer);
/*============================ IMPLEMENTATION ================================*/
...
static void ui_event_cb(lv_event_t *ptEvent)
{
    ...
    /**
     * @note This is a template for the event callback function. You can
     * add your event handling code here and bind it to the components
     * in the emb_lv_scene_ui_create function.
     */
}
...
static void ui_timer_cb(lv_timer_t *ptTimer)
{
    ...
    /**
     * @note This is a template for the timer callback function. You can
     * add your timer handling code here and bind it to the timer in the
     * emb_lv_scene_ui_create function.
     */
}
/*============================ END ===========================================*/
