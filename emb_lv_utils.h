...
#if __EMB_USE_MISC_LIST__
#   include "emb_list.h"
#else 
#   include "emb_lv_list.h"
#endif

#ifndef ___EMB_LV_CONF_SKIP_HEADER___
...
#define EMB_SCENE_DECLARATION(WHICESCENE)                      \
        extern emb_lv_scene_t *g_ptScene##WHICESCENE;                            
